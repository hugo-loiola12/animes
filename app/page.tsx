...
const Home = () => {
  return (
    <div className="text-center">
      <h1
        className={`mb-4 mt-5 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white ${fraunces.variable} font-titulo`}
      >
      ...
      <div className="flex flex-wrap justify-center p-5 sm:p-10">
        <div className="w-full sm:w-1/3 p-2">
          <div className="h-64 w-full object-cover transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0">
            <Image layout="fill" src={Img1} alt="image description" />
          </div>
        </div>
        <div className="w-full sm:w-1/3 p-2">
          <div className="h-64 w-full object-cover transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0">
            <Image layout="fill" src={Img2} alt="image description" />
          </div>
        </div>
        <div className="w-full sm:w-1/3 p-2">
          <div className="h-64 w-full object-cover transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0">
            <Image layout="fill" src={Img3} alt="image description" />
          </div>
        </div>
      </div>
    </div>
